...
class MonitorLineChartWidget3 extends StatefulWidget {
  final List<PowerEntity> powerList;
  final double maxX;
  final double maxY;
  final double minY;

  const MonitorLineChartWidget3({
    super.key,
...
class MonitorLineChartWidgetState extends State<MonitorLineChartWidget3> {
