...
import 'package:cescpro/page/station/revenue/index.dart' show QueryType;
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class BuildSelectTimeWidget2 extends StatefulWidget {
  final StopDegreeLogic logic;
  const BuildSelectTimeWidget2({super.key, required this.logic});

  @override
  State<BuildSelectTimeWidget2> createState() => _BuildSelectTimeWidgetState();
}

class _BuildSelectTimeWidgetState extends State<BuildSelectTimeWidget2> {
