                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ///正向
                                  buildChildItem(
                                    title: "${item.endVerPos ?? 0}",
                                  ),
                                  buildChildItemDiver(),
                                  buildChildItem(
                                    title: "${item.endHigPos ?? 0}",
                                  ),
                                  buildChildItemDiver(),
                                  buildChildItem(
                                    title: "${item.endMidPos ?? 0}",
                                  ),
                                  buildChildItemDiver(),
                                  buildChildItem(
                                    title: "${item.endLowPos ?? 0}",
                                  ),
                                  buildChildItemDiver(),
                                  buildChildItem(
                                    title: "${item.endBatChargeWhSum ?? 0}",
                                  ),
                                ],
                              ),
                            ),
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ///负向
                                  buildChildItem(
                                    title: "${item.endVerNeg ?? 0}",
                                  ),
                                  buildChildItemDiver(),
                                  buildChildItem(
                                    title: "${item.endHigNeg ?? 0}",
                                  ),
                                  buildChildItemDiver(),
                                  buildChildItem(
                                    title: "${item.endMidNeg ?? 0}",
                                  ),
                                  buildChildItemDiver(),
                                  buildChildItem(
                                    title: "${item.endLowNeg ?? 0}",
                                  ),
                                  buildChildItemDiver(),
                                  buildChildItem(
